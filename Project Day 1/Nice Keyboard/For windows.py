...
class CenteredBlinkKeyboard(QWidget):
    def __init__(self, port_name, baud_rate):
        ...
        # open serial properly
        self.serial = serial.Serial(port_name, baud_rate, timeout=0.1)
        print(f"Connected to {self.serial.name}")
...
if __name__ == "__main__":
    ...
    gui = CenteredBlinkKeyboard(SERIAL_PORT, BAUD_RATE)
    gui.show()
    sys.exit(app.exec())